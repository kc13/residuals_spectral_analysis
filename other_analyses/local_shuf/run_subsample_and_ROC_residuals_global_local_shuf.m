%run_subsample_and_ROC_residuals_global_local_shuf.m
% assumes run_simulations_stdFR_stdRP.m has been run first
% note ROC stage all pairs comprised of 2 of 3 methods:
% global shuffling, local shuffling, residuals
% the ROC cropping (to account for variable FA ranges) accounts for 
% all three of these at once, although comparisons are ultimately
% pairwise.  Generally, results change little if cropping is 
% done pairwise.
% see statsF and related structs generated at end of script for 
% the pAUC comparison results
...
%% 
randdir = pwd;
randfile = 'rnd_info_subsample_res_shufG_shufL.mat';
