%run_subsample_and_ROC_stdFR_stdFRP_splines.m
% assumes run_simulations_stdFR_stdRP_splines.m
% has been run first
% see statsF and related structs generated
% towards the end of the script for information
% about pAUC statistical test results
...
%% 
randdir = pwd;
randfile = 'rnd_info_subsample_stdFR_stdRP_splines.mat';
...
outdir = pwd;
suffix = 'stdFR_stdRP_splines_new';
write = true;
