%figS7_HR_diffs_highFR_synthetic.m
%%
clear all;  
close all;
clc;
...
oti = sprintf('synthetic data: %s differences (residuals - shuffling), high FRs (%u ms RP, k = %0.1f)',...
	dmap(d),nr,k);  
...
if testwrite
    outdir = pwd;
    outfile = 'figS7_HR_diffs_highFR_synthetic.tif';
    mkdir(outdir)
