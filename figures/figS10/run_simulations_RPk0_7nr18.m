% run_simulations_stdFR_RPk0.7nr18.m
...
%%
randdir = pwd;
randfile = 'rnd_info_sim_stdFR_RPk0.7nr18.mat';
randpath = fullfile(randdir,randfile);
%% will generate with a _new suffix so as to not
% overwrite those used for figure 4
write = false; %switch save on/off
outdir = pwd;
suffix = '';
