...
%%
xcArr = [E(1).corr_results; E(2).corr_results];
sArr = [E(1).shuf_results; E(2).shuf_results];
rArr = [E(1).res_results; E(2).res_results];
uArr = [E(1).unit_data; E(2).unit_data];
leglocArr = {'Southeast','Northeast'};
tiArr = {['example #1: ', aA{:}, ' unit'],...
    ['example #2: ', aB{:}, ' unit']};
