%figS12_eval_synthetic_RPk0nr3.m
%
%%
clear all;
close all;
...
datadir = pwd;
nSS = 1000;
ssfile = 'subsample1000_stdFR_RPk0nr3.mat';   
sspath = fullfile(datadir,ssfile);
gridfile = 'HRFAtable_stdFR_RPk0nr3.mat';
gridpath = fullfile(datadir,gridfile);
rpfile = 'RPtable_stdFR_RPk0nr3.mat';
...
oti = 'synthetic spike trains: method evaluation (low to moderate FRs, 3 ms RP, k = 0.0)';
otisz = 10.5;
nP = 3; nC = 1; 
...
if testwrite
    outdir = pwd;
    outfile = 'figS12_eval_synthetic_RPk0nr3.tif';
    mkdir(outdir)
