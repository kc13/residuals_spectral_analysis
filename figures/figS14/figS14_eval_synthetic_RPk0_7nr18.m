%figS14_eval_synthetic_RPk0_7nr18.m
%
%%
clear all;
close all;
...
datadir = pwd;
nSS = 1000;
ssfile = 'subsample1000_stdFR_RPk0.7nr18.mat';   
sspath = fullfile(datadir,ssfile);
gridfile = 'HRFAtable_stdFR_RPk0.7nr18.mat';
gridpath = fullfile(datadir,gridfile);
rpfile = 'RPtable_stdFR_RPk0.7nr18.mat';
...
oti = 'synthetic spike trains: method evaluation (low to moderate FRs, 18 ms RP, k = 0.7)';
otisz = 10.5;
nP = 3; nC = 1; 
...
if testwrite
    outdir = pwd;
    outfile = 'figS14_eval_synthetic_RPk0.7nr18.tif';
    mkdir(outdir)
