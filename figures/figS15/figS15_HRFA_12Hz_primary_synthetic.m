%figS15_HRFA_12Hz_primary_synthetic.m
%%
clear all;  
close all;
clc;
...
fo = FOarr(3); % focus on 12 Hz specifically

oti = sprintf('synthetic data: method hit rates and false alarms for f_{osc} = %u Hz (low to moderate FRs, %u ms RP, k = %0.1f)',fo,9,0.7);
otifs = 10;
nR = 4; nC = nNW;
...
if testwrite
    outdir = pwd;
    outfile = 'figS15_HRFA_12Hz_primary_synthetic.tif';
    mkdir(outdir)
