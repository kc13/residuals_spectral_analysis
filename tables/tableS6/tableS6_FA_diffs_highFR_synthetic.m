%tableS6_FA_diffs_highFR_synthetic.m
%%
clear all;  
close all;
clc;
...
tabledir = datadir;
tablefile = 'FALM_3I_lag_highFR.xlsx'; 
...
% FA processed the same way to be consistent
ix = T.M ~= 0;
yh = T.FADRC(ix);
nw = T.NW(ix);
fo = T.FO(ix);
...
tbl.Properties.VariableNames = {'T','f_osc','pbOff','m','m2','FAdiff'};
